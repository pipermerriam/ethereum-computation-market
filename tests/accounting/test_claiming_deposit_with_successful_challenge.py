...
def test_reclaiming_deposit_with_successful_challenge(deploy_client,
    ...
    assert d_a['value'] == deposit_amount + 1 - gas_reimbursments
    assert d_a['to'] == deploy_coinbase

    assert d_b['value'] == deposit_amount + 2
